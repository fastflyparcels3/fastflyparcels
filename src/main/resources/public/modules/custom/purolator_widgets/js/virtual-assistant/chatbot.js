...
window.onload = function() {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Fastfly Parcels-DEV-FR');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Fastfly Parcels-PROD-FR');
      }
    } else {
      if (enviromentCheck()) {
        el.setAttribute('data-prop-brand-uri', 'Fastfly Parcels-DEV');
      } else {
        el.setAttribute('data-prop-brand-uri', 'Fastfly Parcels-PROD');
      }
    }
...
function openChatbot(parameter) {
  ...
  if (isIE() || window.matchMedia('(max-width: 992px)').matches == true) {
    ...
    if (langCheck()) {
      ...
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Fastfly Parcels-DEV-FR"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Fastfly Parcels-PROD-FR"+param;
      }
    } else {
      dropinTitle = "Puro Virtual Assistant";
      if (enviromentCheck()) {
        dropinSrc = "https://t.virtualchatpurolator.com/#/Fastfly Parcels-DEV"+param;
      } else {
        dropinSrc = "https://prod.virtualchatpurolator.com/#/Fastfly Parcels-PROD"+param;
      }
    }
